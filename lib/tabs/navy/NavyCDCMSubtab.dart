...
class NavyCDCMSubtab extends StatefulWidget {
  @override
  _NavyCDCMSubtabState createState() => _NavyCDCMSubtabState();
}

class _NavyCDCMSubtabState extends State<NavyCDCMSubtab> {
